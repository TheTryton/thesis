...
{
    static_assert(std::is_trivial_v<error_t>);

    struct error_t_category : std::error_category
    {
...
namespace std
{
    ...
    {
        return error_code{static_cast<int>(error.value()), VULKAN_RENDER_NAMESPACE::error_category};
    }
}
